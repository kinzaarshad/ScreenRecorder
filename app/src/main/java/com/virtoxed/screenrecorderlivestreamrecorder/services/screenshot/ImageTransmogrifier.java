...
package com.virtoxed.screenrecorderlivestreamrecorder.services.screenshot;
...
public class ImageTransmogrifier implements ImageReader.OnImageAvailableListener {
  ...
  private final ControllerService svc;
  private Bitmap latestBitmap=null;
  private boolean shouldCapture;

  @SuppressLint("WrongConstant")
  public ImageTransmogrifier(ControllerService svc) {
    this.svc=svc;
